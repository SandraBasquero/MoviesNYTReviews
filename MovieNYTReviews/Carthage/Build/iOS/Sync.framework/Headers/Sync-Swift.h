...
SWIFT_AVAILABILITY(macos,introduced=10.12) SWIFT_AVAILABILITY(tvos,introduced=10) SWIFT_AVAILABILITY(watchos,introduced=3) SWIFT_AVAILABILITY(ios,introduced=10)
